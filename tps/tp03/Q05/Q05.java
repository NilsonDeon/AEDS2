...
class Q05{
    ...
    public static void main(String args[]) throws Exception, ParseException {
        ...
        String valores = "", str = "";
        int i = 0, j = 0, k = 0, id = 0, tamanho = 0;
    ...
    // inserindo entrada do usuario na lista
        ...
        //int[] counts = lista.heapsortLista();
        lista.heapsortLista(tamanho);
        lista.impirmirLista();
...
class Lista{
    ...
    public void heapsortLista(int tamanho){
    ...
    public void heapfy(int tamanho, int i ){
        ...
        if(esquerda < tamanho && comparaData( jogos[esquerda].getRelease_date(), jogos[maior].getRelease_date()) == 1 ){
            maior = esquerda;
        }

        if(direita < tamanho && comparaData( jogos[direita].getRelease_date(), jogos[maior].getRelease_date()) == 1 ){
            maior = direita;
        }
        ...
        if(maior != i){
            ...
            heapfy(tamanho, maior);
        }


    }

    public int comparaData(Date data1, Date data2){

        int resposta = 0;

        DateFormat dateFormat = new SimpleDateFormat("MMM/yyyy", Locale.US);
        String[] d1 = dateFormat.format(data1).split("/");
        String[] d2 = dateFormat.format(data2).split("/");
        ...
        if(Integer.parseInt(d1[1]) > Integer.parseInt(d2[1])){
            ...
            if( mesToInt(d1[0]) >= mesToInt(d2[0]) ){
                resposta = 1;
            }
